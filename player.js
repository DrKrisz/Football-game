...
export class Player {
    ...
    checkTrophies() {
        ...
        if (Math.random() < 0.25) {
            this.leagueTitles++;
            showEventMessage('League Title Won!', true);
        }
